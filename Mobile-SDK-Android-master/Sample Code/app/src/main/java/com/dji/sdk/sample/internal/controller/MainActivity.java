...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onResume() {
        super.onResume();
        // Start the telemetry task when the activity is ready
    ...
    protected void onPause() {
        super.onPause();
        // Stop the telemetry task when the activity goes into the background
        stopTelemetryTask();
    }
            ...
            AsyncTask.execute(new Runnable() {
                ...
                public void run() {
                    ...
                    DJISDKManager.getInstance().registerApp(MainActivity.this.getApplicationContext(), new DJISDKManager.SDKManagerCallback() {
                        ...
                        @Override
                        public void onDatabaseDownloadProgress(long l, long s){
   ...
   --- _time
    ...
    protected void startTelemetryTask() {
        ...
        TimerTask task = new TimerTask() {
            ...
            public void run() {
                try {
                    Log.e("VELOCITY_X", String.valueOf(DJISampleApplication.getAircraftInstance().getFlightController().getState().getVelocityX()));
                    Log.e("VELOCITY_Y", String.valueOf(DJISampleApplication.getAircraftInstance().getFlightController().getState().getVelocityY()));
                    Log.e("VELOCITY_Z", String.valueOf(DJISampleApplication.getAircraftInstance().getFlightController().getState().getVelocityZ()));
                    Log.e("HEADING_DIRECTION",String.valueOf(DJISampleApplication.getAircraftInstance().getFlightController().getState().getAircraftHeadDirection()));
                    Log.e("ALTITUDE",String.valueOf(DJISampleApplication.getAircraftInstance().getFlightController().getState().getAircraftLocation().getAltitude()));
                    Log.e("LATITUDE",String.valueOf(DJISampleApplication.getAircraftInstance().getFlightController().getState().getAircraftLocation().getLatitude()));
                    Log.e("LONGITUDE",String.valueOf(DJISampleApplication.getAircraftInstance().getFlightController().getState().getAircraftLocation().getLongitude()));
                    Log.e("FLIGHT_MODE",String.valueOf(DJISampleApplication.getAircraftInstance().getFlightController().getState().getFlightModeString()));
                    Log.e("SATELLITE_COUNT",String.valueOf(DJISampleApplication.getAircraftInstance().getFlightController().getState().getSatelliteCount()));
                    Log.e("ULTRASONIC_HEIGHT",String.valueOf(DJISampleApplication.getAircraftInstance().getFlightController().getState().getUltrasonicHeightInMeters()));
